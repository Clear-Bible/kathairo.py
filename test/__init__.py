...
def test_mapped_verses_are_present(tsv_vrs_name_files):
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as out_file:
        ...
        for row in data_frame.itertuples():
            ...
            if(source_verse not in tsv_source_verses):            
                ...
                while(source_verse != source_verse_range_end):
                    print(source_verse, source_verse_range_end)
...
with open(json_file) as json_data:
    ...
    for jsonObject in jsonData:
        ...
        versification_issues_file = get_target_file_location("TSVs", projectName+"_vrs_issues", language)
