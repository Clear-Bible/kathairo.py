...
from machine.scripture.verse_ref import VerseRef, Versification, are_overlapping_verse_ranges
from machine.utils.string_utils import has_sentence_ending
from machine.corpora.corpora_utils import gen, merge_verse_ranges
...
from machine.corpora.usfm_token import UsfmAttribute, UsfmToken, UsfmTokenType
from machine.corpora.usfm_parser_handler import UsfmParserHandler

from machine.corpora.usfm_text_base import UsfmTextBase

class ModifiedTextRowCollector(UsfmParserHandler):
